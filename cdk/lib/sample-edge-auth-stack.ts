  ...
  constructor(scope: Construct, id: string, props?: cdk.StackProps) {
    ...
    const userPoolClient = userPool.addClient("UserPoolClient", {
      ...
      oAuth: {
        ...
        callbackUrls: [cloudFrontUrl, `${cloudFrontUrl}/`, "http://localhost:5173/", "https://localhost:5173/"],
        logoutUrls: [cloudFrontUrl, `${cloudFrontUrl}/`, "http://localhost:5173/", "https://localhost:5173/"],
      },
      authFlows: {
        userPassword: true,
        userSrp: true,
